...
TREE_LOGS = ('minecraft:acacia_log', 'minecraft:birch_log',
             ...
             'minecraft:oak_log', 'minecraft:spruce_log', 'minecraft:mangrove_log')

MUSHROOM_BLOCKS = ('minecraft:mushroom_stem', 'minecraft:red_mushroom_block', 'minecraft:brown_mushroom_block')

TREE_BLOCKS = TREE_LOGS + MUSHROOM_BLOCKS + ('minecraft:bamboo','minecraft:vine','minecraft:mangrove_roots','minecraft:moss_carpet','minecraft:bee_nest')

LEAF_BLOCKS = ('minecraft:acacia_leaves', 'minecraft:birch_leaves',
             'minecraft:dark_oak_leaves', 'minecraft:jungle_leaves',
             'minecraft:oak_leaves', 'minecraft:spruce_leaves',
             'minecraft:azalea_leaves', 'minecraft:mangrove_leaves', 'minecraft:flowering_azalea_leaves')
