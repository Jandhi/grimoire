...
class Fruit_Shop:
    counter_goods: list = (
        ...
        'player_head{SkullOwner:{Id:[I;-483863813,-2117778070,-2110758150,349817437],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNzJkZjRlNjc0OTUxYzEzOGU3MzExMTI3NTYxZmRiZDI3ZTIxNTA3MTZiMDJiYjU2ODc0N2Y4NTQ1ZmIyMDE0NSJ9fX0="}]}}}',
    )  # tomato
...
class Armour_Shop:
    counter_goods: list = (
        ...
        'player_head{SkullOwner:{Id:[I;864431335,1436894342,-1274960042,1899380984],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNGFmZjNmZmYzYWQ1ZDEwODA4Mzc5YWUyMDFiODMyYmZlZThhYzIyNjVmYmJlNjg0MTdkMTBmYjVmNThiMmQ4NSJ9fX0="}]}}}',
    )  # knight helmet

    floor_goods: list = (
        'armor_stand{ShowArms:1b,NoBasePlate:1b,ArmorItems:[{id:"minecraft:leather_boots",Count:1b},{id:"minecraft:leather_leggings",Count:1b},{id:"minecraft:leather_chestplate",Count:1b},{id:"minecraft:leather_helmet",Count:1b}]}',
...
class Bakery_Shop:
    counter_goods: list = (
        ...
        'player_head{SkullOwner:{Id:[I;-228580091,-1028111819,-1318891776,1652123010],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNjMyNTQ1YTk4OTdjNGYwODA5ZDdlOWQ3ZGU0YjQ5OWNhZmQ4ZDZhNDJhMGVhY2Y0Y2FhYmYzNDg4YWRjYTIxMSJ9fX0="}]}}}',
    )  # bread
...
class Bell_Pepper_Shop:  # 4 different pepper colours
    counter_goods: list = (
        'player_head{SkullOwner:{Id:[I;1344612946,1873821837,-1292649600,1454823410],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNjVmNzgxMDQxNGEyY2VlMmJjMWRlMTJlY2VmN2E0Yzg5ZmM5YjM4ZTlkMDQxNGE5MDk5MTI0MWE1ODYzNzA1ZiJ9fX0="}]}}}',
...
class Japanese_Shop:
    counter_goods: list = (
        'player_head{SkullOwner:{Id:[I;-383345864,-2114305331,-1190798659,1984883991],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNTBlMzBlODhiMmQyMGFkMDZlMjc5MWM4M2Q1YTQxZGE3YmYyZDJlMzBmZWVjZGNiOGU0ZTFmMWFiNzE4OTA1In19fQ=="}]}}}',  # takoyaki
        ...
        'player_head{SkullOwner:{Id:[I;-26572071,311050408,-1779130003,1709813103],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNGMwOTU5NmE4Yzk4YTNlNjlhNjYwNzliY2MwN2I4MWIwMzZjOTIwNGI3YWJjODdjMTgyMDRlZDg0ZDc4OTM0MCJ9fX0="}]}}}',
    )  # sushi
...
class Honey_Shop:
    counter_goods: list = (
        ...
        'player_head{SkullOwner:{Id:[I;2061359882,1553943730,-2026977421,1376425424],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYjkwNmJmZDgxN2NjNTgxOGM3NjIwZTI4OGY0ZTQxMzAxNDMxOGMwYmNiYjVlY2Q2ZGE4YTU5MjNkNTFjNTJmMiJ9fX0="}]}}}',
    )  # honeyjar
...
class Donut_Shop:  # all blocks are donuts
    counter_goods: list = (
        'player_head{SkullOwner:{Id:[I;532742587,-1304212876,-1697788453,1676318830],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZGY1OTI1ZWQ1MDM2MWY5Yjc5MWRkMDgyODkxMTE4ZTYwYjljM2ZhZWQ2Nzc1MDQ5ZmYyOTM4YmU4MTMxMDQ1MSJ9fX0="}]}}}',
...
class Butcher_Shop:
    counter_goods: list = (
        'player_head{SkullOwner:{Id:[I;-1697893344,482626784,-1900324603,-1837649629],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMTg0ZGZhN2YxMTBhMjliNzZkNDUwMjE2NjRhYWQzNDRlOWE5OGVmODdkOWRlMWQyMzViMzEwNzFmYTVkMTAxOCJ9fX0="}]}}}',  # turkey
        ...
        'player_head{SkullOwner:{Id:[I;-987506310,1707690889,-1924457192,-1478082841],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZDgwN2YyMDk0MmQ4NGEzYjczM2ExYTJkNjZkZTQ3NWJmNDE2YzJlNmM1NTQyMTM2Nzc0MmIxNzcwNmJhMjE1OSJ9fX0="}]}}}',
    )  # ham
...
class Alcohol_Shop:
    counter_goods: list = (
        'player_head{SkullOwner:{Id:[I;-733558164,2016231772,-1917138577,-484030463],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYmQyYjY1Yjc5YjQ5MDQ1MTRhMGZjNzIzMmVhODlhOWU4YzZhYzYwZWUzZGJhMWI1OTc1Yjc3NTUxMjczMzhhNCJ9fX0="}]}}}',  # wine
        ...
        'player_head{SkullOwner:{Id:[I;-1513351130,1351370996,-1551837317,-2013369534],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvOGY3ZGM4YzkxZjdhMjRlY2Q5YzVlOWQ0ZDhjMzlmMGFjODMzM2FlNDg1MzU1OWFjYjhiMDM4NjZmOWQifX19"}]}}}',
    )  # beer medieval
